...
from my_loader import word_mapping, char_mapping, tag_mapping, gazetteer_mapping, brown_mapping
...
if len(opts.brown.strip()) > 0:
    parameters['brown'] = opts.brown
...
# Load sentences
train_sentences, dev_sentences = loader.load_sentences(opts.train, lower, zeros, ratio=0.8)
# dev_sentences = loader.load_sentences(opts.dev, lower, zeros)
test_sentences, _ = loader.load_sentences(opts.test, lower, zeros)
